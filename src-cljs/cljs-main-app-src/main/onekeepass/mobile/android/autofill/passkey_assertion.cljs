(ns onekeepass.mobile.android.autofill.passkey-assertion
  "UI for the passkey assertion page shown in the Android Credential Manager flow."
  (:require [onekeepass.mobile.android.autofill.events.passkey-assertion :as pk-events]
